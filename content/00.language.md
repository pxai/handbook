...
puts a ** b            # 16
## Símbolos
Mención aparte merecen los símbolos en Ruby. Los símbolos permiten hacer lo mismo que hace una cadena o String, peroso de Ruby, lo que see lee se guarda como tipo string.
puts 10 / 7            # 1
puts 10.0 / 7          # 1.42857...
puts 10 / 7.0          # 1.42857...
```
...
me.greet  # Hi, my name is Iñigo Montoya
```
